...
/**
 * Baseline class used from building {@link ScriptTypeInterface} output for {@link
 * UiLibraryInterface} Resources.
 */
public abstract class BaseScriptBuilder {
   ...
   */
  public abstract ScriptTypeInterface getScriptType();
   ...
   */
  public abstract String getOutput(UiLibraryInterface uiLibrary);
   ...
   */
  @Nonnull
  public <T extends ScriptFile> List<T> getFiles(final UiLibraryInterface uiLibrary) {
   ...
   */
  public <T extends ScriptFile> String getUncompiledOutput(final UiLibraryInterface uiLibrary) {
   ...
   */
  public static BaseResource getScriptsRootResource(final ScriptTypeInterface scriptType,
  ...
  private <T extends ScriptFileInterface> void appendFileOutputToStringBuilder(final T file,
